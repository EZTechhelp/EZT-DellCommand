...
#----------------------------------------------
$dashboardreport = "''' + itsm.getParameter('Dashboard_Report') + '''" #enables generating an HTML Report containing all Dell Updates found
$opendashboardreport = "''' + itsm.getParameter('Open_Dashboard_Report') + '''" #enables immediately opening the report in the default browser after its created. Disable if using through RMM or other remote tools
$save_report_location = "''' + itsm.getParameter('Save_Report_Location') + '''" #directory where the HTML dashboard report should be saved. If left blank, the report will be deleted after its generated or emailed
$email_report = "''' + itsm.getParameter('Email_Report') + '''" #enables sending the HTML report via email. Configure email variables if enabled
$email_logs = "''' + itsm.getParameter('Email_Logs') + '''" # enables attaching the script log file to the email sent with the report. 
#---------------------------------------------- 
...
#----------------------------------------------
$SmtpPassword =  "''' + itsm.getParameter('SMTP_Password') + '''"
$SmtpUser =  "''' + itsm.getParameter('SMTP_User') + '''"
$SmtpPort = "''' + itsm.getParameter('SMTP_Port') + '''"
$SmtpServer = "''' + itsm.getParameter('SMTP_Server') + '''"
$MailFrom = "''' + itsm.getParameter('SMTP_From') + '''"
$MailTo = "''' + itsm.getParameter('SMTP_To') + '''"
$Subject = "''' + itsm.getParameter('SMTP_Subject') + '''"
#---------------------------------------------- 
...
$logfile_directory = "''' + itsm.getParameter('LogFile_Directory') + '''" # directory where log file should be created if enabled
#---------------------------------------------- 
